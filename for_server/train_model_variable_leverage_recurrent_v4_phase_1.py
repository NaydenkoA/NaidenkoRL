...
TARGET_LEVERAGE = 3
PRIMORDIAL_FORGET_BIAS = 1.8
SEED = 400
THREADS = 10
WIDTH = 0.2
PRIMORDIAL_ACTION_PENALTY = 0.5
PENALTY_DAMPING = 0.995
ECHO_REWARD_DAMPING = 0.93
ECHO_REWARD_SCALE = 0.7
...
POSITIVE_CONSEQUANCE_REWARD = 0.2
NEGATIVE_CONSEQUANCE_PENALTY = 0.3

log_dir = "variable_leverage_model_v4_phase_1/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.set_parameters("variable_leverage_model_v4/ppo_model_phase_0")

    with torch.no_grad():
        lstm = model.policy.lstm_actor
        H = lstm.hidden_size
        lstm.bias_ih_l0[H:2*H] = PRIMORDIAL_FORGET_BIAS/2
        lstm.bias_hh_l0[H:2*H] = PRIMORDIAL_FORGET_BIAS/2

        lstm = model.policy.lstm_critic
        H = lstm.hidden_size
        lstm.bias_ih_l0[H:2*H] = PRIMORDIAL_FORGET_BIAS/2
        lstm.bias_hh_l0[H:2*H] = PRIMORDIAL_FORGET_BIAS/2
    ...
    model.save("variable_leverage_model_v4_phase_1/ppo_model_phase_1")
    vec_env.save("variable_leverage_model_v4_phase_1/vecnormalize_stats.pkl")
...
def plot_metrics_v4(history):
    fig, axs = plt.subplots(38, 1, figsize=(16, 70), sharex=True)
    ...
    axs[32].plot(history['leverage slope abs'])
    axs[32].set_ylabel('leverage slope abs')

    axs[33].plot(history['volatile token slope abs'])
    axs[33].set_ylabel('volatile token slope abs')

    axs[34].plot(history['calm part slope abs'])
    axs[34].set_ylabel('calm part slope abs')

    axs[35].plot(history['equilibrium distance'])
    axs[35].set_ylabel('equilibrium distance')

    axs[36].plot(history['equilibrium distance slope'])
    axs[36].set_ylabel('equilibrium distance slope')

    axs[37].plot(history['equilibrium distance mean'])
    axs[37].set_ylabel('equilibrium distance mean')

...
vol_token_price = vol_token_price[::6]
...
if __name__ == "__main__":
    ...
    print(ACTION_PENALTY_SCALE)

    log_dir = "loop_model_wbera/ppo_mixed"
    ...
    model_raw.save("loop_model_wbera/ppo_model_raw")
    vec_env.save("loop_model_wbera/vecnormalize_stats.pkl")
    ...
    model_step_1.set_parameters("loop_model_wbera/ppo_model_raw.zip")
    ...
    #model_step_1.save("loop_model_wbera/ppo_model_step_1")
    vec_env.save("loop_model_wbera/vecnormalize_stats.pkl")
    model_step_1.save("loop_model_wbera/ppo_model_final")
    ...
    model_1.set_parameters("loop_model_wbera/ppo_model_step_1.zip")
    ...
    model_1.save("loop_model_wbera/ppo_model_final")
    vec_env.save("loop_model_wbera/vecnormalize_stats.pkl")"""
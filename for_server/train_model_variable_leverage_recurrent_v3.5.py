...
log_dir = "variable_leverage_model_v3.5/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.save("variable_leverage_model_v3.5/ppo_model_final")
    model.save("variable_leverage_model_v3.5/ppo_model_phase_0")
    vec_env.save("variable_leverage_model_v3.5/vecnormalize_stats.pkl")
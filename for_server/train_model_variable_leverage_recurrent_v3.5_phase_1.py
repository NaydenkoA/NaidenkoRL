...
SCALE = 6.5*10**7
TOTAL_TIMESTEPS = 2*1024*300 #default 200
TARGET_LEVERAGE = 3
SEED = 400
THREADS = 10
WIDTH = 0.2
...
log_dir = "variable_leverage_model_v3.5_phase_1/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.set_parameters("variable_leverage_model_v3.5/ppo_model_phase_0")
    ...
    model.save("variable_leverage_model_v3.5_phase_1/ppo_model_phase_1")
    vec_env.save("variable_leverage_model_v3.5_phase_1/vecnormalize_stats.pkl")
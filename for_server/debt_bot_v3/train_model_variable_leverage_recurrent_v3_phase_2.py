...
if __name__ == "__main__":
    ...
    model.set_parameters("variable_leverage_model_v3_phase_1/ppo_model_phase_1")
    ...
    model.save("variable_leverage_model_v3_phase_2/ppo_model_phase_2")
    vec_env.save("variable_leverage_model_v3_phase_2/vecnormalize_stats.pkl")
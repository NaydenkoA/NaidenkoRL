...
SCALE = 6.5*10**7
TOTAL_TIMESTEPS = 2*1024*400 #default 200
TARGET_LEVERAGE = 3
SEED = 400
THREADS = 10
WIDTH = 0.4
...
POSITIVE_CONSEQUANCE_REWARD = 0.25
NEGATIVE_CONSEQUANCE_PENALTY = 0.35

log_dir = "variable_leverage_model_v4_phase_2/ppo_mixed"
...
if __name__ == "__main__":
    ...
    vec_env = SubprocVecEnv([
        ...
        make_env_modified(3, 2 - WIDTH/2, 2 + WIDTH/2), 
    ...
    model.set_parameters("variable_leverage_model_v4_phase_1/ppo_model_phase_1")

    model.learn(total_timesteps=int(TOTAL_TIMESTEPS), callback=combined_eval_callbacks)
    model.save("variable_leverage_model_v4_phase_2/ppo_model_phase_2")
    vec_env.save("variable_leverage_model_v4_phase_2/vecnormalize_stats.pkl")
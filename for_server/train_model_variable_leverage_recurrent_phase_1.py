...
REWARD_SCALE = 1*math.sqrt((1 - 0.97)/(1 - 0.95))
REWARD_BOUND = 2
IDLE_REWARD = 0.09
OPTIMAL_REBALANCING_REWARD = 0.085 #0.08
EXTRAVAGANCE_PENALTY = 0.1
LIQUIDATION_PENALTY_SCALE = 0
LOSS_PENALTY_SCALE = 0
BOUNDARY_REWARD_SCALE = 0

log_dir = "variable_leverage_model_recurrent_phase_1/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.set_parameters('variable_leverage_model_recurrent/ppo_model_phase_0')
    ...
    model.save("variable_leverage_model_recurrent_phase_1/ppo_model_phase_1")
    vec_env.save("variable_leverage_model_recurrent_phase_1/vecnormalize_stats.pkl")
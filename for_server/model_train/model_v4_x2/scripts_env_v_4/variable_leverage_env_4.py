...
class agentDLVEnvV4(gym.Env):
    ...
    def reset(self, seed = None, options = None, top_leverage = None, bottom_leverage = None):
        ...
        self.calm_part_gain_mean_normed = self._normalize_slope(self.calm_part_gain_mean, False)
    ...
    def step(self, action):
        ...
        if action != 0:
            ...
            if self.last_rebalance_step != self.last_mechanical_intervention:
                ...
                if abs(drift*norm) < 0.2 or self.last_delta_leverage == 0:
                    drift = 0
                else:
                    if drift < 0:
        ...
        self.leverage_gain_mean_normed = self._normalize_slope(self.leverage_gain_mean)
        self.vol_token_gain_mean_normed = self._normalize_slope(self.vol_token_gain_mean, 4000)

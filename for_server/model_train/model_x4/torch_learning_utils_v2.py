...
def generateEpisode(rng, model: reccurentActor, env1: agentDLVEnvV3, env2: agentDLVEnvV3, epsilon = None, confidence_level = 0.99):
...
def train_model(
    ...
    for episode in trange(n_episodes, desc="Training"):
        ...
        for ep in ep_data_full:
            ...
            advantage = current_reward - reward_baseline
            reward_baseline = (1 - baseline_alpha) * reward_baseline + baseline_alpha * current_reward

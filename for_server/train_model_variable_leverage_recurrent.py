...
log_dir = "variable_leverage_model_recurrent/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.save("variable_leverage_model_recurrent/ppo_model_final")
    model.save("variable_leverage_model_recurrent/ppo_model_phase_0")
    vec_env.save("variable_leverage_model_recurrent/vecnormalize_stats.pkl")
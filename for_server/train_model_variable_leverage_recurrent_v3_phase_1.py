...
log_dir = "variable_leverage_model_v3_phase_1/ppo_mixed"
...
if __name__ == "__main__":
    ...
    model.set_parameters("variable_leverage_model_v3/ppo_model_phase_0")
    ...
    model.save("variable_leverage_model_v3_phase_1/ppo_model_phase_1")
    vec_env.save("variable_leverage_model_v3_phase_1/vecnormalize_stats.pkl")
...
class hybridDLVEnv(gym.Env):
    def __init__(
        ...
        super(hybridDLVEnv, self).__init__()
    ...
    def step(self, action):
        ...
        if action_penalty!=0:
            action_penalty = action_penalty + 100*cost/current_nav
        ...
        leverage_reward = plateau(2*self.leverage_margin) - 1*abs(self.leverage_margin)
